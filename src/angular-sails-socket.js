angular.module('angularSails.io', [])
   ...
   */
    .provider('sailsSocketFactory', function() {
        ...
        //default prefix for events forwarded to angular scopes.
        // eg - $rootScope.$on('sails:foobar',function(ev,data){})
        var defaultPrefix = 'sails:';

        //placeholder to allow passing in an existing socket.io socket.
        var ioSocket = undefined;

        // expose to provider
        return {
            '$get' : ['$q', '$rootScope', '$timeout', '$window',
